...
video.ontimeupdate = function ()
{
    ...
    var c_sec = c_duration - parseInt(c_duration/60)*60;
    var t_sec = t_duration - parseInt(t_duration/60)*60;
    v_timing.innerHTML = parseInt(c_duration/60) +":"+ parseInt(c_sec)+" / "+parseInt(t_duration/60) +":"+parseInt(t_sec);
    ...
    if(v_name.value != "" && v_link.value != "")
        {
            ...
            var v_txt = JSON.stringify(v_object);
...
<button id="video_play_btn" type="button">Play</button><button id="video_delete_btn" type="button">Delete</button>
</div>
*/
